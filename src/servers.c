...
const char strsTELNET[] ICACHE_RODATA_ATTR STORE_ATTR = {
  "Servers Telnet Socket fails %s errno: %d\n"
};
const char strsWEB[] ICACHE_RODATA_ATTR STORE_ATTR = {
  "Servers Web Socket fails %s errno: %d\n"
};
const char strsWSOCK[] ICACHE_RODATA_ATTR STORE_ATTR = {
...
ICACHE_FLASH_ATTR void serversTask(void* pvParams) {
  ...
  sdk_os_timer_setfn(&sleepTimer, sleepCallback, NULL);
  sdk_os_timer_setfn(&wakeTimer, wakeCallback, NULL);
